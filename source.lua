                      ...
                      _class_4 = setmetatable({
                        __init = function(self, parent, flag, options)
                          ...
                          self.check = self.window:add_object("ImageLabel", {
                            ...
                            Size = UDim2.new(0, 14, 0, 14),
                            Position = UDim2.new(0, 0, 0, 0),
                            Image = crypt.base64.decode(assets.checkmark),
                      ...
                      _class_4 = setmetatable({
                        __init = function(self, parent, flag, options)
                          ...
                          self.arrow = self.window:add_object("ImageLabel", {
                            ...
                            Image = crypt.base64.decode(assets.triangle),
          ...
          _class_2 = setmetatable({
            __init = function(self, parent)
              ...
              self.left_group = self.parent:add_object("ScrollingFrame", {
                ...
                MidImage = crypt.base64.decode(assets.square),
    ...
    _class_1 = setmetatable({
      __init = function(self, title, position, size)
        ...
        self:add_object("ImageLabel", {
          Name = generate_guid(),
          BackgroundTransparency = 1,
          Image = crypt.base64.decode(assets.colorpicker),
          BorderSizePixel = 0,
          Size = UDim2.new(1, 0, 1, 0),
          Position = UDim2.new(0, 0, 0, 0),
        ...
        self:add_object("ImageLabel", {
          Name = generate_guid(),
          BackgroundTransparency = 1,
          Image = crypt.base64.decode(assets.colorpicker_location),
          BorderSizePixel = 0,
          Size = UDim2.new(1, 0, 1, 0),
          Position = UDim2.new(0, 0, 0, 0),
        ...
        self.hue_slider_location = self:add_object("ImageLabel", {
          Name = generate_guid(),
          BackgroundTransparency = 1,
          Image = crypt.base64.decode(assets.slider_location),
          BorderSizePixel = 0,
        ...
        local transparent_pattern = self:add_object("ImageLabel", {
          Name = generate_guid(),
          BackgroundTransparency = 1,
          Image = crypt.base64.decode(assets.transparent_pattern),
          BorderSizePixel = 0,
